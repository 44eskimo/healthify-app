...
import HealthyLiving from './HealthyLiving.png'
import './index.css'
                ...
                <form>
                    ...
                    <div className="rowing">
                        ...
                        <div className="login-buttons-container">
                                ...
                                <Link to="/register">
                                    <button class="button-68">Register</button>
                                </Link>
                        </div>
                        <img src={HealthyLiving} className='healthyLiving' alt="poster" />
                        </div>
            ...
            <p className='middle-para4'>¨Exercise is labor without weariness.¨ — Indiana Jones
                ...
                <div className='last-content'>
                    <div className='lastflex-1'>
                            <h3 className='lastflex1-heading'>Follow us on</h3>
                    ...
                    <div className='lastflex-3'>
                        <h3 className='lastflex3-heading'>Contact Info</h3>
