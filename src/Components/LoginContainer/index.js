...
const LoginContainer = () => {
    ...
    const navigate = useNavigate();
        ...
        const handleSubmit = () => {
            const account = users.find((each) => each.username === username && each.password === password)
        ...
        <h1 className="login-heading" >Welcome to Healthify App for Good Health, Wealth & Fitness</h1>
            <form>
                ...
                <div className="rowing">
                    ...
                    <div className="loginContainer-buttons-container">
                        <div>
                        <input type="text" placeholder="Username" className='m-2 form-control' value={username}  onChange={(e) => {setUsername(e.target.value)}} />
                        <input type="password" placeholder="Password" className='m-2 form-control' value={password} onChange={(e) => {setPassword(e.target.value)}}/>
                        ...
                        <div className="login-container-rowing">
                            ...
                            <div>
                                ...
                                <label className="checkbox-label m-2" for="check">Remember me</label>
                            </div>
                            <div>
                            <button class="button-68 button" type='submit' onClick={handleSubmit} >Login</button>
    ...
    <div className='middle-content'>
        ...
        <div className='flex-3'>
            ...
            <p className='middle-para3'>“Be so good they can't ignore you.” — Eminem</p>
        </div>
